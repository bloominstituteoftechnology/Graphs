...
var GraphView = function (_Component) {
  ...
  _createClass(GraphView, [{
    ...
    key: 'randomRGBA',
    value: function randomRGBA(r, g, b, a) {
    ...
    value: function updateCanvas() {
      var canvas = document.getElementById('LS'); //this.ref.canvas;       
...
var App = function (_Component2) {
  ...
  function App(props) {
    ...
    _this2.state = { graph: new _graph.Graph() };
    return _this2;
  }
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'App' },
        _react2.default.createElement(GraphView, { graph: this.state.graph })
      );
    }
  }]);
 ...
 * Edge
 */
var Edge = exports.Edge = function Edge(destination) {
...
var Vertex = exports.Vertex = function Vertex(value) {
...
var Graph = exports.Graph = function () {
  ...
  _createClass(Graph, [{
    key: 'randomize',
    value: function randomize(width, height, pxBox) {
      var probability = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 0.6;
        ...
        for (var _x5 = 0; _x5 < width; _x5++) {
          ...
          if (_y < height - 1) {
            if (Math.random() < probability) {
              connectVerts(grid[_y][_x5], grid[_y + 1][_x5]);
            }
          }
          ...
          if (_x5 < width - 1) {
            if (Math.random() < probability) {
              connectVerts(grid[_y][_x5], grid[_y][_x5 + 1]);
            }
          }
        }
      }
      ...
      var boxBuffer = 0.8;
      var boxInner = pxBox * boxBuffer;
      var boxInnerOffset = (pxBox - boxInner) / 2;
      ...
      for (var _y3 = 0; _y3 < height; _y3++) {
        for (var _x7 = 0; _x7 < width; _x7++) {
          this.vertexes.push(grid[_y3][_x7]);
        }
      }
    }
  }, {
    ...
    value: function dump() {
      ...
      try {
        for (var _iterator = this.vertexes[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var v = _step.value;
          ...
          try {
            for (var _iterator2 = v.edges[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
              var e = _step2.value;
    ...
    key: 'bfs',
    value: function bfs(start) {
      var closure = [start];
      var hash = _defineProperty({}, '' + start.value, 1);
      // two closures are defined and initialized with the first vertex
      var loop_extract = function loop_extract(vertex) {
