...
class Graph:
    ...
    def dfs(self, start, target=None):
        ...
        while stack:
            ...
            # Substract what's visited from the vertices and
    ...
    def bfs(self, start, target=None):
        ...
        while queue:
            current = queue.pop(0) # Pops the last one
            ...
            # Substract what's visited from the vertices and what's remaining, add it to the stack
