...
class BokehGraph:
    ...
    def show (self):
        ...
        source = ColumnDataSource(dict(xvals=xcir,yvals=ycir,name=node_indices))

        labels = LabelSet(x='xvals', y='yvals', text='name',x_offset=-4,y_offset=-8, level='glyph',source=source, text_color='white')
