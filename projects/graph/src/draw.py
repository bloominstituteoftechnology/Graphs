...
class BokehGraph:
    ...
    def __init__(self, graph, title='Graph', width=10, height=10, show_axis= True, show_grid= True,
     circle_size=35,draw_components= False):
      ...
      # Set up plot, the convas/space to draw on
