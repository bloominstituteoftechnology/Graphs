...
class BokehGraph(Graph):
    ...
    def _setup_graph_renderer(self, circle_size, draw_components):
        ...
        if draw_components:
            graph_renderer.node_renderer.data_source.add(self._get_connected_component_colors(), "color")
        else:
    ...
    def randomize(self):
        ...
        for vertex in self.vertex_keys:
            self.pos[vertex.label] = (random.randint(10, 500), random.randint(10, 500))
