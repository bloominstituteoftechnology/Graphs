...
export class Graph {
  ...
  // need to get found arrays out of fuctions

  // Method number 1: have bfs return an array, and have getConnectedComponents return
  // an array of arrays.

  // Method number 2: Declare our array of arrays in graph, and change it directly
