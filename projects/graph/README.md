...
A: 100 users with 10 friends each is 1000 connections, but because each call of the `addFriendship()` method creates 2 connections, it will only need to be called 500 times.
