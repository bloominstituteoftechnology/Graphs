...
Answer: 500 times because on addFriendship both the user to friend and friend to user friendships will be created simultaneously and to account for that we must decrease our method calls by half.
