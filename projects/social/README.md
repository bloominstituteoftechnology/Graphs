...
500 times.  100 users with 10 frienships would be 1000 single directional friend relationships.  Since our model uses bidirectional friendships (If I am your friend, then you are my friend by definition), and our add_friendship() method takes that into account, we will only run it 500 times.

2. If you create 1000 users with an average of 5 random friends each, what percentage of other users will be in a particular user's extended social network? What is the average degree of separation between a user and those in his/her extended network?  

Average Degree = 5000/1000 = 5 degrees of separation
