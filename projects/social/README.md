...
> To create 100 users with an average of 10 friends each, you need to call 
> add_friendship() roughly 1100 times.  That is because, at random for every 
> 10 method calls, we'll get a friendship collision (ie. a call where the friendship
