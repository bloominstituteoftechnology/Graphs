...
#print("Starting room is: ", world.startingRoom, "end")
print("RoomGraph is: ", roomGraph[0])
print("RoomGraph2 is: ", roomGraph[0][0])
print("RoomGraph3 is: ", roomGraph[0][0][0])
#print(roomGraph[0][0][0])
# print(roomGraph.keys())
# print(roomGraph.values())
# print(roomGraph)

# for i in roomGraph:
#     print("Room is: ", i)
#     test = roomGraph.get(i)
#     print("First retrieval: ", test)
#     test2 = test[1]
#     print("second retrieval: ", test2)
#     # print("Get test: ", test[1])
#     test3 = test2.get(i)
