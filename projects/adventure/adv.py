...
for i in roomGraph.items():
    ...
    #     roomNeighborsNumbers.add(j)
    #     roomList[i[0]] = roomNeighborsNumbers
    # # Adding neighbors as NSEW
    # for k in i[1][1].keys():
    #     roomNeighborsDirections.add(k)
    #     roomDirections[i[0]] = roomNeighborsDirections
print("Room graph transmogrified: ", roomNeighbors)
...
# def get_key(val): 
#     for key, value in roomNeighbors.items(): 
#          if val == value: 
#              return key 
...
#     print("i is: ", i)
#     #print("I + 1 = ", traversalPath[i+1])
#     #print("Next neighbor is: ", i+1)
#     print("i value is: ", roomNeighbors[i])
key_list = list(roomNeighbors.keys()) 
val_list = list(roomNeighbors.values()) 
...
print("traversal before cleaning: ", traversalPath)
for prev,item,next in neighborhood(traversalPath):
    if item == next:
        print(item)
        traversalPath.remove(item)
    # print("traversal after cleaning: ", traversalPath)
    # if next is not None:
    #     if roomNeighbors[item] == roomNeighbors[next].values:
    #         print("Match found: ", roomNeighbors[item], " to ", roomNeighbors[next].values)
    # #print("item", item, " is ", roomNeighbors[item].values())
    
    #     print("next", next, " is ", roomNeighbors[next])
    # if prev is not None:
...
# for i in traversalPath:
#     print("i is ", i)
#     print("test 1", roomNeighbors[i])
#     for j in roomNeighbors[i]:
#         print("Room is ", i, "Key 1 is", j, "value is ", roomNeighbors[i][j])
#         if i == 

# for i in roomNeighbors:
#     print("i is ", i)
#     for j in traversalPath:
        #print("j is ", j)
        #print("j[1] is ", j[i])
        #print("test 2 ", roomNeighbors[i][j])
    # print("test1", key_list[val_list.index(i)])
    # print("test1", val_list[key_list.index(i)])
#print("test2", key_list.index(0))

# print(key_list[val_list.index(item)]) 
    # print("test", key_list[val_list.index(i)])
# for i in roomNeighbors.values():
#     print("i2 is ", i)

#     print("test", key_list[val_list.index(i)])
# print("traversal before conversion: ", traversalPath)
# for prev,item,next in neighborhood(traversalPath):
#     #print("test", roomNeighbors[item])
#     print (prev, item, next)
# print("traversal after conversion: ", traversalPath)
...
# 2) Find a path that, when walked, will visit every room at least once
    # a) Find path to end points - depth first recursively - find all endpoints
        # endpoint = no exits
        # Check - unvisited nodes = destination after all endpoints visited

    # b) Keep track of amount of backtracking required?
